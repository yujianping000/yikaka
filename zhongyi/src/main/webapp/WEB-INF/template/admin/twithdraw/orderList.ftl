        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                	<form id="listForm" action="${base}/admin/twithdraw/order_list.jhtml" method="get">
                    ...
                    <div class="ibox-content">
                    	<div class="row">
					        ...
					        <input type="text" placeholder="请输入订单编号" name="filter_bn" id="filter_bn" value="${(paramter.filter_bn)!''}" class="input-sm form-control">
                            </div>
					        <div class="col-sm-3 m-b-xs">
					        <input type="text" placeholder="请输入下单账号" name="filter_phone" id="filter_phone" value="${(paramter.filter_phone)!''}" class="input-sm form-control">
                            </div>
					        <div class="col-sm-3 m-b-xs">
					        	<div class="input-daterange input-group" id="datepicker">
					        		<input type="text" placeholder="请输入下单时间" name="filter_sDate" id="filter_sDate" value="${(paramter.filter_sDate)!''}"  class="input-sm form-control  ">
					        		<span class="input-group-addon">——</span>
					        		<input type="text" placeholder="请输入下单时间" name="filter_eDate" id="filter_eDate" value="${(paramter.filter_eDate)!''}" class="input-sm form-control  "> 
                            	</div>
                            </div>        
					        <div class="col-sm-3 m-b-xs">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example dataTable">
                                ...
                                <tbody>
                                	 [#list page.content as order] 
							        	 <tr>
					                        <td>
					                            <input type="checkbox" class="i-checks" name="ids" value="${order.id}">
					                        </td>
					                        <td>${(order.bn)!''}</td>
					                        <td>${(order.phone)!''}</td>
