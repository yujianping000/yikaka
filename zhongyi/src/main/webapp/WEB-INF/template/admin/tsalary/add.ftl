                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="edit1" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">自定义2</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="edit2" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="edit3" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
