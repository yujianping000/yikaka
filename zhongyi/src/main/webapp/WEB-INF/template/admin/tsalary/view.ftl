...
<head>
    ...
    <title>${setting.siteName} - 工资表详情</title>
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.uid}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.orgId}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">底薪</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.basicSalary}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.courseSalary}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">绩效</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.performanceSalary}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.allTsutomu}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">奖金</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.bonus}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.pushMoney}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">报销</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.reimburse}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.edit1}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">自定义2</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.edit2}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tSalary.edit3}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
