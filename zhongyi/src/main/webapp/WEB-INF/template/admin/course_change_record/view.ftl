...
<head>
    ...
    <title>${setting.siteName} - 调班跟进详情</title>
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${courseChangeRecord.recordTime}</p>
	                                </div>
                       			</div>
							</div></div>
	<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${courseChangeRecord.record}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">跟进人姓名</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${courseChangeRecord.name}</p>
	                                </div>
                       			</div>
							</div></div>
	<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${courseChangeRecord.remark}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">创建日期</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${courseChangeRecord.createTime}</p>
	                                </div>
                       			</div>
							</div></div>
	<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${courseChangeRecord.changId}</p>
	                                </div>
                       			</div>
							</div></div>
	<!--/row-->
