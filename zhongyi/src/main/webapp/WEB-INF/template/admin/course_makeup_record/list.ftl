...
<head>
    ...
    <title>${setting.siteName} - 补课跟进管理</title>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    	<div class="row">
					        ...
					        <div class="col-sm-3 m-b-xs">
					        <input type="text" placeholder="请输入补课id" name="filter_makeupId" value="${(paramter.makeupId)!''}" class="input-sm form-control">
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example dataTable">
                                ...
                                <tbody>
                                	 [#list page.content as courseMakeupRecord] 
							        	 <tr>
					                        <td>
					                            <input type="checkbox" class="i-checks" name="ids" value="${courseMakeupRecord.id}">
					                        </td>
					                        <td>${(courseMakeupRecord.id)!''}</td>
					                        ...
					                        <td>${(courseMakeupRecord.createTime?string('yyyy-MM-dd'))!''}</td>
					                        <td>${(courseMakeupRecord.makeupId)!''}</td>
					                        <td>
					                        	<a href="${base}/admin/course_makeup_record/view/${courseMakeupRecord.id}.jhtml" class="btn btn-xs btn-default"> ${message("admin.common.view")} </a>
					                        	
					                        	<a class="btn btn-info btn-xs btn-edit-loippi" data-id="${courseMakeupRecord.id}" href="edit/${courseMakeupRecord.id}.jhtml" ><i class="fa fa-paste"></i> ${message("admin.common.edit")} </a>
					                        	
					                        	<a class="btn btn-danger btn-xs btn-delete-loippi" data-id="${courseMakeupRecord.id}" ><i class="fa fa-trash"></i> ${message("admin.common.delete")} </a>
					                        </td>
					                    </tr>
							        [/#list] 
                                </tbody>
