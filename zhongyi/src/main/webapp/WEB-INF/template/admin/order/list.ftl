                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                    	 ...
                    	 <div class="ibox-tools">
                    	 	<a class="btn btn-primary btn-xs" id="btn-add-loippi" href="add.jhtml">手动记账</a>
                    	...
                    	<div class="row">
							  ...
							  <option [#if  paramter.payType==1] selected='selected'[/#if]  value ="1">支付宝</option>
							   ...
							   <option [#if  paramter.payType==3] selected='selected'[/#if]  value ="3">银联</option>
						   	   <option [#if  paramter.payType==4] selected='selected'[/#if]  value ="4">现金</option>
						</select>
                            </div>
						   ...
						   <div class="dataTables_wrapper form-inline">
						        [#if tallyType==1]
						        	<table class="table table-striped" style="border:0;width:50%" >
														<tbody>
															<tr>
																<td >总收入金额：<font color="orange" size="3">${orderInfo.totalFeeInfo}</font></td>
																<td>订单数量：<font color="orange" size="3">${orderInfo.ordernum}</font></td>
																<td>订单金额：<font color="orange" size="3">${orderInfo.paymentInfo}</font></td>
																<td>手续费：<font color="orange" size="3">${orderInfo.procedureCostInfo}</font></td>
															</tr>
														</tbody>
													</table>
                                ...
                                <tbody>
                                	 [#list page.content as order] 
							        	 <tr>
					                        ...
					                        <td>${(order.remark)!''}</td>
					                          <td>
					                              <a href="javascript:showRemark(${(order.id)!''})" class="btn btn-info btn-xs btn-edit-loippi">修改备注 </a>
					                          </td>
					                    </tr>
							        [/#list] 
                                </tbody>
			...
			//导出收入管理表
			 $(".tOrderExport").click(function(){
			    ...
			    var filter_tallyType = $("#filter_tallyType").val();
			 	...
			 	window.open('tOrderExport.jhtml?filter_payType='+filter_payType
