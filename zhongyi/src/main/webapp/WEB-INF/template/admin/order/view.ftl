                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.targetId}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">订单类型  1-课程   2-活动报名</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.type}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.unickname}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.stuId}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label"></label>
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.cancelReason}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.payType}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">支付金额</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.payment}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.payedFee}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.sellerRate}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">创建时间</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.createdTime}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.consignTime}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.endTime}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">更新时间</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.updateTime}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.timeOutTime}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">取消时间</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.cancelTime}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.buyerRate}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">评论状态 1-正常   2-已关闭</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.rateStatus}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.disabled}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">取消状态</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.cancelStatus}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.courseId}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.orgId}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.stuAvatar}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.stuAge}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label"></label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${order.image}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
