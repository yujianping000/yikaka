...
<head>
    ...
    <title>${setting.siteName} - 试课跟进管理</title>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    	<div class="row">
					        ...
					        <div class="col-sm-3 m-b-xs">
					        <input type="text" placeholder="请输入试课id" name="filter_bookId" value="${(paramter.bookId)!''}" class="input-sm form-control">
                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example dataTable">
                                ...
                                <tbody>
                                	 [#list page.content as courseBookRecord] 
							        	 <tr>
					                        <td>
					                            <input type="checkbox" class="i-checks" name="ids" value="${courseBookRecord.id}">
					                        </td>
					                        <td>${(courseBookRecord.id)!''}</td>
					                        ...
					                        <td>${(courseBookRecord.createTime?string('yyyy-MM-dd'))!''}</td>
					                        <td>${(courseBookRecord.bookId)!''}</td>
					                        <td>
					                        	<a href="${base}/admin/course_book_record/view/${courseBookRecord.id}.jhtml" class="btn btn-xs btn-default"> ${message("admin.common.view")} </a>
					                        	
					                        	<a class="btn btn-info btn-xs btn-edit-loippi" data-id="${courseBookRecord.id}" href="edit/${courseBookRecord.id}.jhtml" ><i class="fa fa-paste"></i> ${message("admin.common.edit")} </a>
					                        	
					                        	<a class="btn btn-danger btn-xs btn-delete-loippi" data-id="${courseBookRecord.id}" ><i class="fa fa-trash"></i> ${message("admin.common.delete")} </a>
					                        </td>
					                    </tr>
							        [/#list] 
                                </tbody>
