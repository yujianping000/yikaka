                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="hourId" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="markTime" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="classStatus" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
