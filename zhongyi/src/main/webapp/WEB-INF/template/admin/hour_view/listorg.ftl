        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                	<form id="listForm" action="${base}/admin/hour_view/listorg/${orgId}/${teaId}.jhtml"  method="get">
                    	...
                    	<div class="row">
					        ...
					        <div class="col-sm-3 m-b-xs">
							  ...
							  <option [#if  paramter.classStatus==2] selected='selected'[/#if]  value ="2">旷工</option>
							    ...
							    <option [#if  paramter.classStatus==4] selected='selected'[/#if]  value ="4">请假</option>
						</select>
                            </div>
