                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                    	 ...
                    	 <div class="ibox-tools">
                    	   [@shiro.hasPermission name ='admin:orguser:edit']
                                	 ...
                                	 [#list page.content as user] 
							        	 <tr>
						                        ...
						                        <td>
						                        	...
						                        	<a class="btn btn-info btn-xs btn-edit-loippi" data-id="${user.id}" href="editorg.jhtml?id=${user.id}" ><i class="fa fa-paste"></i> 编辑</a>
