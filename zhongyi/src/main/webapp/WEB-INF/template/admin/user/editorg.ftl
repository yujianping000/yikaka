...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                  	...
                  	<div class="ibox-content">
                  		<form id="saveAclForm" class="form-horizontal" action="updateorg.jhtml" method="post">
  ...
  <tr>
    <td><div style="height:150px;width: 300px;float: left;">
		<img style="height:150px;width: 300px; "  id="imageImg" name='imageImg' src="${user.avatar}"/>
</div>
 <td>
</tr>
     <tr>
...
<input type="hidden"  name="avatar" id="image" value="${user.avatar}" />
