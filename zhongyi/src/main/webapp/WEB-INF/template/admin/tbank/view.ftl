...
<head>
    ...
    <title>${setting.siteName} - 银行详情</title>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                  	...
                  	<div class="ibox-content">
                  		...
                  		<input type="hidden" value="${tBank.id}" name="id"/>
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tBank.bankName}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tBank.bankAccount}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">持卡人</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${tBank.bankUserName}</p>
	                                </div>
                       			</div>
							</div></div>
							<!--/row-->
