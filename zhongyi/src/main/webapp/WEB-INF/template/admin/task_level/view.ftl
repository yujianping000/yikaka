...
<head>
    ...
    <title>${setting.siteName} - 任务等级详情</title>
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${taskLevel.level}</p>
	                                </div>
                       			</div>
							</div></div>
	<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${taskLevel.levelValue}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">图片1</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${taskLevel.levelImage1}</p>
	                                </div>
                       			</div>
							</div></div>
	<!--/row-->
                            ...
                            <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${taskLevel.levelImage2}</p>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">图片3</label>
	                                <div class="col-sm-9">
	                                	<p class="form-control-static">${taskLevel.levelImage3}</p>
	                                </div>
                       			</div>
							</div></div>
	<!--/row-->
