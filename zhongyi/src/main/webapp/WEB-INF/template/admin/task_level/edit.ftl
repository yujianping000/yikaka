                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                  	...
                  	<div class="ibox-content">
                  		<form id="inputForm" class="form-horizontal" action="${base}/admin/task_level/update.jhtml" method="post">
                  		<input type="hidden" value="${taskLevel.id}" name="id"/>
                           ...
                           <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="level" class="form-control" maxlength="200" value="${(taskLevel.level)!''}"/>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">等级积分值</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="levelValue" class="form-control" maxlength="200" value="${(taskLevel.levelValue)!''}"/>
	                                </div>
                       			</div>
							</div>
                        </div>
...
<table border="0">
  <tr>
    <td><div style="height:150px;width: 300px;float: left;">
		...
		<img style="height:150px;width: 300px; "  id="imageImg" name='imageImg' src="${(taskLevel.levelImage1)!''}"/>
...
<input type="hidden"  name="levelImage1" id="image" value="${(taskLevel.levelImage1)!''}" />
...
<table border="0">
  <tr>
    <td><div style="height:150px;width: 300px;float: left;">
		...
		<img style="height:150px;width: 300px; "  id="imageImg2" name='imageImg2' src="${(taskLevel.levelImage2)!''}"/>
...
<input type="hidden"  name="levelImage2" id="image2" value="${(taskLevel.levelImage2)!''}"/>
...
<table border="0">
  <tr>
    <td><div style="height:150px;width: 300px;float: left;">
		...
		<img style="height:150px;width: 300px; "  id="imageImg3" name='imageImg3' src="${(taskLevel.levelImage3)!''}"/>
...
<input type="hidden"  name="levelImage3" id="image3" value="${(taskLevel.levelImage3)!''}"/>
