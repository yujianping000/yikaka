	            ...
	            <div class="ibox float-e-margins">
	                <div class="ibox-title">
	              	...
	              	<div class="ibox-content">
	              		<form id="inputForm" class="form-horizontal" action="${base}/admin/course/updateCourseTime.jhtml" method="post">
	                     ...
	                     <div class="form-group">
	                   		<div class="row">
	                   			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">调课日期  <span style="color:#F00">(*)</span></label>
	                                <div class="col-sm-9">
	                                    <div class="input-daterange input-group col-sm-3" id="datepicker">
					        				...
					        				[/#if]
					        				[#if courseTeaTime.type == 2]
					        					<input type="text" placeholder="年/月/日" name="changeTime" id="changeTime" value="${(courseTeaTime.courseTime?string('yyyy-MM-dd'))!''}" class="input-sm form-control  ">
					        				[/#if]
					        			</div>
	                                </div>
                       			</div>
	                   			 	...
	                   			 	<label class="col-sm-3 control-label">调课时间<span style="color:#F00">(*)</span></label>
		                                 ...
		                                 <div class="input-group "> 
	                                 		[#if courseTeaTime.type != 2]
	                               			...
	                               			[/#if]
	                               			[#if courseTeaTime.type == 2]
	                                			<input type="text" class="input-sm  form-control clockpicker" name="changeStart" placeholder="开始" value="${(courseTeaTime.courseTime1)!''}"/>
	                              				<span class="input-group-addon">到</span>
	                               				<input type="text" class="input-sm  form-control clockpicker2 "  name="changeEnd" placeholder="结束" value="${(courseTeaTime.courseTime2)!''}" />
	                               			[/#if]
										</div>
									</div>
                    			</div>
