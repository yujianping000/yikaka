                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                  	...
                  	<div class="ibox-content">
                  		<form id="inputForm" class="form-horizontal" action="${base}/admin/course/updatelist.jhtml" method="post">
                       		...
                       		<div class="row">
                       			<div class="col-sm-6">
                                    ...
                                    <tr>
                                        ...
                                        <th>周</th>
                                         <th>操作 
                                         　　<a class="btn btn-outline btn-success btn-xs" id="btn-add-loippi" href="${base}/admin/course/addlisttime/${course.id}.jhtml"><i class="fa fa-plus"></i>新增课时</a>
