	    ...
	    <div class="row">
	        <div class="col-sm-12">
	            <div class="ibox float-e-margins">
	            	<form id="listForm" action="${base}/admin/org_teacher/userRate/${teacher.id}.jhtml" method="get">
	...
	<script>
	    $(document).ready(function () {
			...
			$(".startUserRate").click(function(){
		    	var $this = $(this);
				 		$.ajax({
							url: "${base}/admin/org_teacher/startUserRate.jhtml",
							type: "POST",
			...
			$(".forbidUserRate").click(function(){
				...
				var $this = $(this);
				 bootbox.confirm("确定禁用?", function(result) {
				 	if(result){
				 		$.ajax({
							url: "${base}/admin/org_teacher/forbidUserRate.jhtml",
							type: "POST",
							data: {id:$this.attr('data-id')},
							dataType: "json",
							cache: false,
