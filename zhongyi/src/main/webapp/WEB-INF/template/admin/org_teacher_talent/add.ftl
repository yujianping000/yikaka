	              				 ...
	              				 <h3 style="color:#3C763D"><i class="fa fa fa-th-list fa-1x"></i>标签信息</h3>
	                       			<div class="row">
	                       				<div class="col-sm-6">
		                                		...
		                                		<div class="col-sm-9">
						    						<input type="text" name="mark1" class="form-control" maxlength="200" />
		                                		</div>
	                       				</div>
	                       				...
	                       				<div class="col-sm-6">
		                                		...
		                                		<div class="col-sm-9">
						    						<input type="text" name="mark2" class="form-control" maxlength="200" />
		                                		</div>
	                       				</div>
	                        	...
	                        	<div class="form-group">
	                       			<div class="row">
	                       				<div class="col-sm-6">
		                                		...
		                                		<div class="col-sm-9">
						    						<input type="text" name="mark3" class="form-control" maxlength="200" />
		                                		</div>
	                       				</div>
	                       			</div>
	                        	</div>
