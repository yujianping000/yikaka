...
<head>
    ...
    <title>${setting.siteName} - 新增教室</title>
                          ...
                          <div class="form-group">
                       		<div class="row">
                                  ...
                                  <option   value="2">集体课</option>   		
                       			...
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">容量（人）</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="peoples" class="form-control" maxlength="3" />
	                                </div>
                       			</div>
							</div>
                        </div>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="area" class="form-control" maxlength="8" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
