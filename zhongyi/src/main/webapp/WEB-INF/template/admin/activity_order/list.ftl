...
﻿﻿﻿﻿﻿﻿﻿﻿[#assign shiro=JspTaglibs["/WEB-INF/tld/shiro.tld"] /]
    ...
    <title>${setting.siteName} - 活动订单管理</title>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                    	 ...
                    	 [@shiro.hasPermission name ='admin:systemactivityorder:edit']
                    	 	<a class="btn btn-outline btn-success btn-xs activityExport"><i class="fa fa-file-excel-o"></i>导出活动订单列表</a>
	                     [/@shiro.hasPermission]
	                    </div>
                    </div>
                    <div class="ibox-content">
                    	<div class="row">
					        ...
					        <div class="col-sm-3 m-b-xs">
					        <input type="text" placeholder="请输入活动名称" name="filter_targetName" id="filter_targetName" value="${(paramter.targetName)!''}" class="input-sm form-control">
                            </div>
					        <div class="col-sm-3 m-b-xs">
                                ...
                                <tbody>
                                	 [#list page.content as order] 
							        	 <tr>
					                        ...
					                        <td>
					                        	<a href="${base}/admin/activity_order/view/${order.id}.jhtml" class="btn btn-xs btn-default"> ${message("admin.common.view")} </a>
					                        </td>
					                    </tr>
							        [/#list] 
                                </tbody>
			...
			//导出
			 $(".activityExport").click(function(){
			    ...
			    var filter_phone = $("#filter_phone").val();
			     var filter_targetName = $("#filter_targetName").val();
			    var filter_sDate = $("#filter_sDate").val();
			    var filter_eDate = $("#filter_eDate").val();
			    var filter_status = $("#filter_status").val();

			 	window.open('activityExport.jhtml?filter_bn='+filter_bn
			 			+'&filter_phone='+filter_phone
			 			+'&filter_targetName='+filter_targetName
