			...
			<div class="col-sm-10 animated fadeInRight">
				...
				<div class="mail-box">
					<div class="ibox-content">
                        <form method="post" id="inputForm" action="${base}/admin/api/interfacer/save.jhtml" class="form-horizontal">
                                ...
                                <div class="col-sm-10">
                                    <select name="categoryId" id="categoryId" data-placeholder="上级接口分类..." class="chosen-select"  style="width:350px;" >
					                 	[#list categories as cate]
					             			<option  hassubinfo="true" value="${cate.id}">${cate.name}</option>
					             		[/#list]
									</select>
                                </div>
                            </div>
                                ...
                                <label class="col-sm-2 control-label">接口地址</label>
                                 <div class="col-sm-2">
                                    <select name="method" id="method" data-placeholder="请求方式..." class="chosen-select"  style="width:350px;" >
					             		<option  hassubinfo="true" value="POST">Post</option>
					             		<option  hassubinfo="true" value="GET">Get</option>
									</select>
                                </div>
                                <div class="col-sm-8">
