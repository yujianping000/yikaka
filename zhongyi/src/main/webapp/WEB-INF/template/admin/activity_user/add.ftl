...
<head>
    ...
    <title>${setting.siteName} - 新增用户活动列表</title>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="aid" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="uaNo" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
