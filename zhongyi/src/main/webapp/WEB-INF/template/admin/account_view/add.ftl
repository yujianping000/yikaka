...
<head>
    ...
    <title>${setting.siteName} - 新增VIEW</title>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="serviceName" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="servicePhone" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">手续费</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="fee" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
