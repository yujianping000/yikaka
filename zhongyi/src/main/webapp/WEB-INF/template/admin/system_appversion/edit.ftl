...
<head>
    ...
    <title>${setting.siteName} - 编辑systemAppversion</title>
                        ...
                        <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="type" class="form-control" maxlength="200" value="${systemAppversion.type!''}"/>
	                                </div>
                       			</div>
							</div>
							<!--/row-->
							<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="version" class="form-control" maxlength="200" value="${systemAppversion.version!''}"/>
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">下载地址</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="url" class="form-control" maxlength="200" value="${systemAppversion.url!''}"/>
	                                </div>
                       			</div>
							</div>
							<!--/row-->
							<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="content" class="form-control" maxlength="200" value="${systemAppversion.content!''}"/>
	                                </div>
                       			</div>
							</div>
							<!--/row-->
