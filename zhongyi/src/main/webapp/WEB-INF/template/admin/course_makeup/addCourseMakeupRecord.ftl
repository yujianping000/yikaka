...
<head>
    ...
    <title>${setting.siteName} - 新增补课跟进</title>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                  	...
                  	<div class="ibox-content">
                  		<form id="inputForm" class="form-horizontal" action="${base}/admin/course_makeup/saveCourseMakeupRecord.jhtml" method="post">
                         <input type="hidden" value="${makeupId}" id="makeupId" name="makeupId"/>
