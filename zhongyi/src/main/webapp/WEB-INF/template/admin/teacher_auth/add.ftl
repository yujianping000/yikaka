...
<head>
    ...
    <title>${setting.siteName} - 新增老师认证</title>
                    ...
                    <div class="ibox-title">
                  	...
                  	<div class="ibox-content">
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">1-全职   2-兼职</label>
	                                <div class="col-sm-9">
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">省份证</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="idCard" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">教师证</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="teacherCard" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="educationCard" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">资历证</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="qlCard" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">对应老师id</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="teacherId" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">1-通过  2-申请中  3-被拒绝</label>
	                                <div class="col-sm-9">
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">相关理由</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="reason" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">1-已读   2-未读</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="isRead" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
