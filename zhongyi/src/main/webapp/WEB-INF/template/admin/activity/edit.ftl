                    ...
                    <div class="ibox-title">
                  	...
                  	<div class="ibox-content">
                  		...
                  		<input type="hidden" value="${activity.id}" name="id"/>
                  		  		<input type="hidden"  value="${activity.locLng}" name="locLng" id="locLng"/>
                  		  		<input type="hidden" value="${activity.locLat}" name="locLat" id="locLat"/>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="name" value="${activity.name}"  class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">活动名额</label>
	                                <div class="col-sm-9">
	                                  <input type="text" name="totalSum"  value="${activity.totalSum}"  class="form-control" maxlength="8" />
	                                </div>
                       			</div>
							</div>
                        </div>
							 ...
							 <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="fee"  value="${activity.fee}"   class="form-control" maxlength="8" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label">年龄范围<span style="color:#F00">(*)</label>
	                                <div class="col-sm-9">
	                                    <input type="text" name="ageRank" value="${activity.ageRank}"    class="form-control" maxlength="50" />
	                                </div>
                       			</div>
							</div>
                        </div>
							 ...
							 <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="company" value="${activity.company}"   class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
...
<input type="hidden"  name="image" id="image" />
	...
	<div class="input-daterange input-group" id="datepicker">
					        		<input type="text" placeholder="请输入时间" name="startTime" id="startTime"  value="${(activity.startTime?string('yyyy-MM-dd'))!''}"  class="input-sm form-control  ">
					        		<span class="input-group-addon">——</span>
					        		<input type="text" placeholder="请输入时间" name="endTime" id="endTime"  value="${(activity.endTime?string('yyyy-MM-dd'))!''}"   class="input-sm form-control  "> 
                            	</div>	                                </div>
                       			</div>
                                 ...
                                 <option  [#if activity.status == "0"]selected[/#if]  value="0">未发布</option>
                                 <option  [#if activity.status == "1"]selected[/#if]  value="1">报名中</option>
                                  <option  [#if activity.status == "2"]selected[/#if]  value="2">进行中</option> 
                                  <option  [#if activity.status == "3"]selected[/#if]  value="3">未开始</option>
                                  <option  [#if activity.status == "3"]selected[/#if]  value="4">已结束</option>  
						   </select>
                       			</div>
                       			</div>
							</div>
						 ...
						 <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="already" value="${activity.already}"  class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
					   ...
					   <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" id="addlocation"  name="location" value="${activity.location}"  class="form-control" maxlength="200" />
	                                </div>
                       			</div>
							</div>
                        </div>
...
if (locLat != '' && locLng != '') {
    ...
    map = new AMap.Map('container', {
        zoom: 14,
        center: [locLng, locLat] //地图中心点
    });
    //添加marker
    marker = new AMap.Marker({
        map: map,
        position: [locLng, locLat],
        bubble: true
    });
