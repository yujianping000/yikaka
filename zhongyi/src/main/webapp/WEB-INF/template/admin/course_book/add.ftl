...
<head>
    ...
    <title>${setting.siteName} - 添加试课申请</title>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
		                                ...
		                                <div class="col-sm-9">
		                                    <input type="text" name="parentAccount" class="form-control" maxlength="200" />
		                                </div>
                       			</div>
                          ...
                          <div class="form-group">
                       		<div class="row">
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="childName" class="form-control" maxlength="200" />
	                                </div>
                       			</div>
                       			<div class="col-sm-6">
