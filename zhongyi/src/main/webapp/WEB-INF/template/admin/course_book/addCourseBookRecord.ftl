                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                  	...
                  	<div class="ibox-content">
                  		<form id="inputForm" class="form-horizontal" action="${base}/admin/course_book/saveCourseBookRecord.jhtml" method="post">
                      	  <input type="hidden" value="${courseBookId}" id="courseBookId" name="courseBookId"/>
