...
public class EasemobIMUsers {
    ...
    public static void main(String[] args) {
      ...
      System.err.println(EasemobIMUsers.activate("6d425a54ac37bd480e918fe6d73d5ec6", dataObjectNode));
    ...
    private  void test(){
        ...
        datanode.put("username","kenshinnuser1007227");
	 ...
	 * @return
	 */
	public static ObjectNode modifyIMUserNameWithAdminToken(String userName, ObjectNode dataObjectNode) {
		ObjectNode objectNode = factory.objectNode();
	 ...
	 * @return
	 */
	public static ObjectNode blocksFriendSingle(String userName, ObjectNode dataObjectNode) {
		ObjectNode objectNode = factory.objectNode();
		...
		try {
			URL blocksFriendSingleUrl = HTTPClientUtils.getURL(Constants.APPKEY.replace("#", "/")
				+"/users/"+userName	+ "/blocks/users" );
			objectNode = HTTPClientUtils.sendHTTPRequest(blocksFriendSingleUrl, credential,
	 ...
	 * @return
	 */
	public static ObjectNode delBlocksFriendSingle(String fromNickName,String targetUserName, ObjectNode dataObjectNode) {
		ObjectNode objectNode = factory.objectNode();
		...
		try {
			URL blocksFriendSingleUrl = HTTPClientUtils.getURL(Constants.APPKEY.replace("#", "/")
				+"/users/"+fromNickName	+ "/blocks/users/"+targetUserName );
			objectNode = HTTPClientUtils.sendHTTPRequest(blocksFriendSingleUrl, credential,
	 ...
	 * @return
	 */
	public static ObjectNode getBlockedFriends(String userName, ObjectNode dataObjectNode) {
		ObjectNode objectNode = factory.objectNode();
		...
		try {
			URL blocksFriendSingleUrl = HTTPClientUtils.getURL(Constants.APPKEY.replace("#", "/")
				+"/users/"+userName	+ "/blocks/users" );
			objectNode = HTTPClientUtils.sendHTTPRequest(blocksFriendSingleUrl, credential,
					dataObjectNode, HTTPMethod.METHOD_GET);
	 ...
	 * @return
	 */
	public static ObjectNode deactivate(String userName, ObjectNode dataObjectNode) {
		ObjectNode objectNode = factory.objectNode();
	 ...
	 * @return
	 */
	public static ObjectNode activate(String userName, ObjectNode dataObjectNode) {
		ObjectNode objectNode = factory.objectNode();
