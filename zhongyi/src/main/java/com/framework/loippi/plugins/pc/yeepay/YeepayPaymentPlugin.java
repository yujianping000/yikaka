...
public class YeepayPaymentPlugin extends PaymentPlugin {
	...
	public Map<String, Object> getParameterMap(String sn, String description, HttpServletRequest request) {
		...
		parameterMap.put("p8_Url", getNotifyUrl(sn, PaymentPlugin.NotifyMethod.general));
	...
	public boolean verifyNotify(String sn ,PaymentPlugin.NotifyMethod notifyMethod, HttpServletRequest request) {
		...
		if (payment != null && generateSign(parameterMap).equals(parameterValuesMap.get("hmac")) && pluginConfig.getAttribute("partner").equals(parameterValuesMap.get("p1_MerId")) && "1".equals(parameterValuesMap.get("r1_Code"))
				&& payment.getAmount().compareTo(new BigDecimal(parameterValuesMap.get("r3_Amt"))) == 0) {
			return true;
		}
		return false;
	}
