package com.framework.loippi.plugins.pc.alipayDual;
...
public class AlipayDualPaymentController extends GenericController {
	...
	public String setting(ModelMap model) {
		...
		return "/com/framwork/loippi/plugins/pc/alipayDualPayment/setting";
	}
