					...
					<div class="page-content" >
						<div class="page-head">
							...
							<div class="page-title">
								<h1><i class="icon-grid" style="font-size: 20px;"></i>&nbsp;${message("admin.plugin.alipayDirect.setting")}   </h1>
							</div>
							<!-- END PAGE TITLE -->
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="javascript:;">${message("admin.plugin.alipayDirect.setting")}</a>
							</li>
						</ul>
						<!-- END PAGE HEADER-->
						<!-- BEGIN PAGE CONTENT-->
								...
								<div class="col-md-12">
									<div class="portlet light bordered">
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form id="inputForm" action="${base}/admin/payment_plugin/alipay_direct/update.jhtml"  method="post" class="form-horizontal">
												<div class="form-body">
												...
												<div class="form-body">
													<div class="form-group">
														<label class="col-md-3 control-label">${message("admin.plugin.alipayDirect.partner")}<span class="required" aria-required="true"> * </span></label>
														<div class="col-md-4">
															<input type="text" name="partner" maxlength="20" value="${pluginConfig.attributes['partner']}" class="form-control" placeholder="${message("admin.plugin.alipayDirect.partner")}">
														</div>
													</div>
												</div>
												<div class="form-body">
													<div class="form-group">
														<label class="col-md-3 control-label">${message("admin.plugin.alipayDirect.key")}<span class="required" aria-required="true"> * </span></label>
														<div class="col-md-4">
															<input type="text" name="key" maxlength="20" value="${pluginConfig.attributes['key']}" class="form-control" placeholder="${message("admin.plugin.alipayDirect.key")}">
														</div>
													</div>
												</div>
												<div class="form-body">
