package com.framework.loippi.plugins.pc.alipayBank;
...
public class AlipayBankPaymentController extends GenericController {
	...
	Message uninstall() {
		if (alipayBankPaymentPlugin.getIsInstalled()) {
			...
			pluginConfigAttributeService.deleteByPluginId(alipayBankPaymentPlugin.getId());
		}
		return SUCCESS_MESSAGE;
	}
	...
	public String setting(ModelMap model) {
		...
		return "/com/framwork/loippi/plugins/pc/alipayBankPayment/setting";
	}
