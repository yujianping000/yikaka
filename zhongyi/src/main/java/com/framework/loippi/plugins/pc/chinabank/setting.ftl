...
<title>${message("admin.plugin.tenpayPartner.setting")} - Powered By KaFuKa</title>
<meta name="author" content="KaFuKa Team" />
<meta name="copyright" content="KaFuKa" />
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.plugin.chinaBankPartner.setting")}
	</div>
