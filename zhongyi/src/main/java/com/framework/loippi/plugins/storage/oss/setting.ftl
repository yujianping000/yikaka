            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                    	 <h5>${message("admin.plugin.oss.setting")}</h5>
                  	...
                  	<div class="ibox-content">
                  		<form id="inputForm" action="${base}/admin/storage_plugin/file/update.jhtml"  method="post" class="form-horizontal">
	                  		<div class="form-group">
	                       		<div class="row">
	                       			<div class="col-sm-6">
	                       			 	<label class="col-sm-3 control-label">${message("admin.plugin.oss.accessId")}<span class="required" aria-required="true"> * </span></label>
	                       			 	 <div class="col-sm-9">
		                                   <input type="text" name="accessId" maxlength="20" value="${pluginConfig.attributesMap['accessId']}" class="form-control" placeholder="${message("admin.plugin.oss.accessId")}">
		                                </div>
