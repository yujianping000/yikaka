...
public class AppOrgnizationn {
	...
	public Integer getIsApplyLeave() {
		return isApplyLeave;
	}


	public void setIsApplyLeave(Integer isApplyLeave) {
		this.isApplyLeave = isApplyLeave;
	}
